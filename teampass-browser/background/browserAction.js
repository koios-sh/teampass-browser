    ...
    return new Promise((resolve, reject) => {
        browser.storage.local.get({ 'settings': {} }).then(function (item) {
            ...
            page.tabs[id].credentials = {
                ...
                url: url,
                title: title,
                usernameExists: existingCredential !== null,
            ...
            //     const buttons = [
            //         {
            //             'title': tr('popupButtonNew')
            //         },
            //         {
            //             'title': tr('popupButtonUpdate')
            //         },
            //         {
...
browserAction.generateIconName = function(iconType, icon) {
    ...
    let name = 'icon_';
    // name += (teampass.teampassUpdateAvailable()) ? 'new_' : '';
